...
describe('convertHTML2PlainString', function () {
  ...
  const html1 = '<p>Hello world</p>'; //Test string with nested html tags

  const html2 = '<div><p>Hello <b>World!</b></p></div>'; //Test string with html tag with attributes

  const html3 = '<div class="test-class">Hello World!</div>'; //Tests
